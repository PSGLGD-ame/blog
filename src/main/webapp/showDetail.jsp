...
<HTML><body background =image/卷.jpg id=tom><center>
<%  try{ 
...
try{ 
	...
	String pic ="<img src='image/"+picture+"' width=800 height=800 ></img>";
	/*if(picture="人.jpg"){
		out.print("<br>有的人循规蹈矩，一生碌碌无为，到老之时唉声叹气，责怪命运的不公平；</br>");
		out.print("<br>而有的人，善于创新，关键时放手一搏，</br>");
		out.print("<br>即使生命短暂，也活出了不一样的精彩，不一样的闪耀。</br>");
		out.print("<br>命运，永远掌握在自己手中，但要看你是怎样对待它的。</br>");
	}*/
